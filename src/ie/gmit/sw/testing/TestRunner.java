...
public class TestRunner {
		...
		public static void main(String[] args) {
			...
			User user = new User("whogan", "password123");
			...
			Query searchUserQuery = new Query(Criteria.where("username").is("whogan"));
			...
			User updatedUser = mongoOperation.findOne(
					new Query(Criteria.where("username").is("whogan")), User.class);
